...
class UpcomingOrde extends StatelessWidget {
  final String image ;
  final String name ;
  final String price ;
  final String date ;
  final String status ;
   ...
   UpcomingOrde({super.key,  required this.name, required this.price, required this.date, required this.image, required this.status});
      ...
      children: [
        InkWell(
          ...
          child: Container(
            ...
            width: 136.w,
            decoration: BoxDecoration(
              color:   const Color.fromRGBO(140, 136, 150, 1),
        ...
        InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color:
              const Color.fromRGBO(235, 156, 155, 1) ,
              borderRadius: BorderRadius.circular(8.r)
            ),
            child: Center(child: Mytext(text: "Rate", color: Colors.white, size: 15.sp, fw: FontWeight.w500)),
          ),
        ),
      ],
    )
